<template>
  <Container>
    ...
    <div class="head-actions flexed space-between">
      ...
      <input type="text" v-model="search" placeholder="Pesquisar" @change="filterProducts">
      <div class="flexed">
        <button class="white mr-14 w256px" @click="redirectToPerguntasNaoRespondidas()">
          Perguntas n/ respondidas
        </button>
...
export default {
	...
	methods: {
		...
		redirectToPerguntasNaoRespondidas() {
			this.$router.push('perguntas-nao-respondidas');
		},
		editProduct(id) {
